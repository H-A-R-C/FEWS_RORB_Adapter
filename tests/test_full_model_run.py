...
example_directory = r"C:\RORB_FEWS_Adapter\examples"
pre_adapter = rf"C:\RORB_FEWS_Adapter\RORB-FEWS-adapter\dist"
...
def test_02_compile_input_files(id, setting, initialize_test_directory):
    ...
    try:
        ...
        par_writer.fill(replacements_dict={
            ...
            "stm__file": f"{model_folder}Rainfall.stm",
        ...
        # Write gateops files
        state_compiler = State(state_xml)
        for key, value in GateOps_big_dict.items():
            ...
            writer.fill(replacements_dict={
                "initial_reservoir_storage": state_compiler.dam[id].level
                }
            )
